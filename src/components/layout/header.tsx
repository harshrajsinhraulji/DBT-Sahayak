...
import { Menu, User, LogOut, LayoutDashboard, Info, BookOpen, Search, GraduationCap, Users, HelpCircle, Phone, GanttChartSquare, Printer, BrainCircuit, FileCheck, Users2, Video, Megaphone, Lightbulb, UserCheck, Map } from "lucide-react";
...
export function Header() {
  ...
  const actionItems = [
      { href: "/eligibility-checker", label: content.header.nav.eligibilityChecker, icon: <UserCheck /> },
      { href: "/form-checker", label: content.header.nav.formChecker, icon: <FileCheck /> },
      { href: "/dbt-map", label: content.header.nav.dbtMap, icon: <Map /> },
